...
# Makes the discord bot send you a notification when its found a shiny.
#For info on how to find your User ID: https://support.discord.com/hc/en-us/articles/206346498-Where-can-I-find-my-User-Server-Message-ID
DISCORD_USER_ID = ""
DISCORD_BOT_KEY = ""
